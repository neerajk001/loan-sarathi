                ...
                <div className="space-y-6">
                  ...
                  <div className="mt-4 bg-gray-50 p-3 rounded-lg border border-gray-200">
                    <p className="text-xs text-gray-600 leading-relaxed text-center">
                      Based on Monthly Net Income of <span className="font-bold">₹{formatCurrency(Number(income) || 0)}</span> and Existing EMI of <span className="font-bold">₹{formatCurrency(Number(existingEmi) || 0)}</span>, your maximum eligible EMI is <span className="font-bold">₹{formatCurrency(maxEmiCapacity)}</span> at <span className="font-bold">{applicableROI.toFixed(2)}% ROI</span> over <span className="font-bold">{eligTenure} years</span> with <span className="font-bold">FOIR 70%</span>
                    </p>
                  </div>
                </div>
