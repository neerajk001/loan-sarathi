...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'With Loan Sarathi, we aim for the fastest turnaround. Personal loans can be approved in as little as 24 hours, while home loans and business loans usually take 3-7 working days depending on documentation.',
      category: 'process',
    },
    {
      id: 3,
